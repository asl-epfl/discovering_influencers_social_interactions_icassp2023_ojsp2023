...
def get_aggregate_influences(combination_matrix, agents, step_size, hypotheses_num, hop=1):
    influences = np.zeros(agents)
    for agent in range(agents):
        influences[agent] = get_all_influences(combination_matrix, agent, step_size,
                                               hypotheses_num, hop).sum()
    return influences